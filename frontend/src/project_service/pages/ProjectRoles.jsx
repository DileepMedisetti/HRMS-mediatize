        ...
        <div className="hrms-page-header">
          <div>
            ...
            <p className="hrms-page-subtitle">
              Define and manage standard roles for employee project assignments (e.g. Lead, Developer, QA).
            </p>
          </div>
          ...
          <div className="hrms-card-body" style={{ padding: 0 }}>
            {loading ? (
              <div style={{ padding: "3rem", textAlign: "center" }}>
                ...
                <p style={{ color: "var(--hrms-text-secondary, #64748b)" }}>Loading project roles...</p>
              </div>
            ) : filteredRoles.length === 0 ? (
              <div style={{ padding: "3rem 1.5rem", textAlign: "center" }}>
                <Briefcase size={40} style={{ color: "var(--hrms-text-muted, #94a3b8)", marginBottom: "0.75rem" }} />
                <h3 style={{ fontSize: "1.125rem", fontWeight: 600, margin: "0 0 0.5rem" }}>
                  {search ? "No matching roles found" : "No project roles created yet"}
                </h3>
                <p style={{ color: "var(--hrms-text-secondary, #64748b)", margin: "0 0 1.25rem" }}>
                  {search
                ...
                <table className="hrms-table">
                  ...
                  <tbody>
                    {filteredRoles.map((role) => (
                      <tr key={role.id}>
                        <td style={{ fontWeight: 600, color: "var(--hrms-text-primary)" }}>
                          {role.name}
                        </td>
                        <td style={{ color: "var(--hrms-text-secondary)", maxWidth: "320px" }}>
                          {role.description || <span style={{ fontStyle: "italic", opacity: 0.6 }}>No description</span>}
                        </td>
                        <td>
                          <RoleStatusBadge isActive={role.is_active} />
                        </td>
                        <td style={{ color: "var(--hrms-text-secondary)", fontSize: "0.875rem" }}>
        ...
        <form onSubmit={handleEditSubmit}>
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
              ...
              />
              <label htmlFor="edit_role_is_active" style={{ cursor: "pointer", fontWeight: 500, fontSize: "0.875rem" }}>
